    ...
    <body>
        <div class=\"container\">
            ...
            <div class=\"recipient-date\" style=\"margin-bottom: 40px;\">
                <div>
                    <div class=\"section-title\" , sans-serif;\">RECIPIENT</div>
                ...
                <div style=\"text-align: right;\">
                    <div class=\"section-title\" , sans-serif;\">DATE</div>
                    <div class=\"section-content\">{invoice_date}</div>
                </div>
            </div>
            <div class=\"delivery-info\" style=\"margin-bottom: 60px;\">
                <div class=\"section-title\" , sans-serif;\">DELIVERY ADDRESS</div>
            ...
            <table>
                <thead>
                    <tr><th , sans-serif;\">HSN</th><th>DESCRIPTION</th><th>QTY</th><th>UNIT</th><th>RATE</th><th>AMOUNT</th></tr>
                </thead>
